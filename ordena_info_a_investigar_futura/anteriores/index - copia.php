...
<td>
<?php if($d['url']): ?>
<a href="<?php echo htmlspecialchars($d['url']); ?>" target="_blank">Abrir</a><br>
<button onclick="mostrarPreview('<?php echo htmlspecialchars($d['url']); ?>', '<?php echo $d['id']; ?>')">
Vista previa
</button>
<div id="preview_<?php echo $d['id']; ?>" class="preview-box"></div>
<?php endif; ?>
</td>
...
function mostrarPreview(url, id) {
    ...
    if (url.includes("youtube.com") || url.includes("youtu.be")) {
        ...
        contenedor.innerHTML = "No se puede generar vista previa.";
    }
}
</script>
